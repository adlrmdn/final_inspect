...
export default function FormView({
  ...
  /**
   * Triggers the dynamic print report PDF generated by the web service,
   * guaranteeing identical layouts across all stages (CMT-Cut through final).
   */
  const handlePrintReport = () => {
    if (activePackagingProject?.project_id && activeSession?.session_id) {
      window.open(`https://vendor-portal.megaperintis.co.id/qc/print/${activePackagingProject.project_id}/${activeSession.session_id}`, '_blank');
    } else {
      window.print();
    }
  };
